    ...
    machineVariants: [
      {
        ...
        superset: {
          title: "Weighted Hollow Body Hold (plate overhead)",
          sets: "2\u00D730s",
          instruction: "Between press sets: grab a 10\u201325 lb plate off the bar (or a spare on the floor), lie back on the mat. LEFT leg flat and heavy \u2014 actively press the back of the left knee into the ground (the quad squeeze inhibits left iliopsoas). Right leg hovers ~20\u00B0 off the floor. Plate held overhead, arms by ears. Exhale, posterior-tilt pelvis so lumbar imprints into the mat, hold. If lower back lifts off \u2014 stop, reset, shorten lever.",
          safety: "Left leg stays flat throughout \u2014 zero iliopsoas demand. If you feel left hip flexor at all, drop the plate, bend the right knee, or call the set. Keep the plate clear of your face; if grip fails, let it drop past your head, not onto it. Alt: weighted McGill Curl-Up (plate on chest, 2\u00D745s) if the overhead hold wrecks your shoulders.",
          note: "Plate is already out from the bar loadout \u2014 no walking, no equipment swap. Stay on the mat, under or just beside the rack.",
        },
      },
    ],
    constraints: {
